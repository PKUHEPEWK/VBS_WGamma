...
void makesmall::Init(TTree* tree) {
    ...
    if (use_f) {
        ...
        ExTree->Branch("photonhaspixelseed_f", &photonhaspixelseed_f, "photonhaspixelseed_f/O");
        ...
        ExTree->Branch("jet1hf_f", &jet1hf_f, "jet1hf_f/I");
        ExTree->Branch("jet1pf_f", &jet1pf_f, "jet1pf_f/I");
        ExTree->Branch("jet2hf_f", &jet2hf_f, "jet2hf_f/I");
        ExTree->Branch("jet2pf_f", &jet2pf_f, "jet2pf_f/I");
        ...
        ExTree->Branch("Dphiwajj_f", &Dphiwajj_f, "Dphiwajj_f/D");
    }
    else {
        // branch have corresponding _f branch
